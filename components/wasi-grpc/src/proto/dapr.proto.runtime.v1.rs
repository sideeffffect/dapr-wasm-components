...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetActorReminderRequest {
    #[prost(string, tag = "1")]
    pub actor_type: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub actor_id: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetActorReminderResponse {
    #[prost(string, tag = "1")]
    pub actor_type: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub actor_id: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListActorRemindersRequest {
    #[prost(string, tag = "1")]
    pub actor_type: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListActorRemindersResponse {
    #[prost(message, repeated, tag = "1")]
    pub reminders: ::prost::alloc::vec::Vec<NamedActorReminder>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct NamedActorReminder {
    #[prost(string, tag = "1")]
    pub name: ::prost::alloc::string::String,
    #[prost(message, optional, tag = "2")]
    pub reminder: ::core::option::Option<ActorReminder>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ActorReminder {
    #[prost(string, tag = "1")]
    pub actor_type: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub actor_id: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UnregisterActorRemindersByTypeRequest {
    #[prost(string, tag = "1")]
    pub actor_type: ::prost::alloc::string::String,
    #[prost(string, optional, tag = "2")]
    pub actor_id: ::core::option::Option<::prost::alloc::string::String>,
...
pub struct UnregisterActorRemindersByTypeResponse {}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsRequestAlpha1 {
    #[prost(
        oneof = "subscribe_actor_events_request_alpha1::RequestType",
        tags = "1, 2, 3, 4, 5, 6"
    )]
    pub request_type: ::core::option::Option<
        subscribe_actor_events_request_alpha1::RequestType,
    >,
}
/// Nested message and enum types in `SubscribeActorEventsRequestAlpha1`.
pub mod subscribe_actor_events_request_alpha1 {
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum RequestType {
        #[prost(message, tag = "1")]
        InitialRequest(super::SubscribeActorEventsRequestInitialAlpha1),
        #[prost(message, tag = "2")]
        InvokeResponse(super::SubscribeActorEventsRequestInvokeResponseAlpha1),
        #[prost(message, tag = "3")]
        ReminderResponse(super::SubscribeActorEventsRequestReminderResponseAlpha1),
        #[prost(message, tag = "4")]
        TimerResponse(super::SubscribeActorEventsRequestReminderResponseAlpha1),
        #[prost(message, tag = "5")]
        DeactivateResponse(super::SubscribeActorEventsRequestDeactivateResponseAlpha1),
        ...
        #[prost(message, tag = "6")]
        RequestFailed(super::SubscribeActorEventsRequestFailedAlpha1),
    }
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsRequestInitialAlpha1 {
    ...
    #[prost(message, optional, tag = "2")]
    pub actor_idle_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    /// Dapr's default.
    #[prost(message, optional, tag = "3")]
    pub drain_ongoing_call_timeout: ::core::option::Option<::prost_types::Duration>,
    ...
    pub drain_rebalanced_actors: ::core::option::Option<bool>,
    /// reentrancy is the default reentrancy configuration applied to all
    /// actor types.
    #[prost(message, optional, tag = "5")]
    pub reentrancy: ::core::option::Option<ActorReentrancyConfig>,
    /// entities_config applies per-actor-type overrides on top of the
    /// defaults above.
    #[prost(message, repeated, tag = "6")]
    pub entities_config: ::prost::alloc::vec::Vec<ActorEntityConfig>,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsRequestInvokeResponseAlpha1 {
    #[prost(string, tag = "1")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsRequestReminderResponseAlpha1 {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
    #[prost(bool, tag = "2")]
    pub cancel: bool,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsRequestDeactivateResponseAlpha1 {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsRequestFailedAlpha1 {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
    #[prost(uint32, tag = "2")]
    pub code: u32,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsResponseAlpha1 {
    #[prost(
        oneof = "subscribe_actor_events_response_alpha1::ResponseType",
        tags = "1, 2, 3, 4, 5"
    )]
    pub response_type: ::core::option::Option<
        subscribe_actor_events_response_alpha1::ResponseType,
    >,
}
/// Nested message and enum types in `SubscribeActorEventsResponseAlpha1`.
pub mod subscribe_actor_events_response_alpha1 {
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum ResponseType {
        #[prost(message, tag = "1")]
        InitialResponse(super::SubscribeActorEventsResponseInitialAlpha1),
        #[prost(message, tag = "2")]
        InvokeRequest(super::SubscribeActorEventsResponseInvokeRequestAlpha1),
        #[prost(message, tag = "3")]
        ReminderRequest(super::SubscribeActorEventsResponseReminderRequestAlpha1),
        #[prost(message, tag = "4")]
        TimerRequest(super::SubscribeActorEventsResponseTimerRequestAlpha1),
        #[prost(message, tag = "5")]
        DeactivateRequest(super::SubscribeActorEventsResponseDeactivateRequestAlpha1),
    }
}
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsResponseInitialAlpha1 {}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsResponseInvokeRequestAlpha1 {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub actor_type: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsResponseReminderRequestAlpha1 {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub actor_type: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsResponseTimerRequestAlpha1 {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub actor_type: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SubscribeActorEventsResponseDeactivateRequestAlpha1 {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub actor_type: ::prost::alloc::string::String,
...
pub struct ActorReentrancyConfig {
    ...
    pub max_stack_depth: ::core::option::Option<i32>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod app_callback_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn on_bulk_topic_event(
            &mut self,
...
pub struct GetMetadataResponse {
    ...
    pub workflows: ::core::option::Option<MetadataWorkflows>,
    #[prost(message, repeated, tag = "13")]
    pub mcp_servers: ::prost::alloc::vec::Vec<MetadataMcpServer>,
    #[prost(message, repeated, tag = "14")]
    pub workflow_access_policies: ::prost::alloc::vec::Vec<MetadataWorkflowAccessPolicy>,
    #[prost(message, repeated, tag = "15")]
    pub resiliencies: ::prost::alloc::vec::Vec<MetadataResiliency>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct MetadataWorkflows {
    #[prost(int32, tag = "1")]
    pub connected_workers: i32,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MetadataWorkflowAccessPolicy {
    #[prost(string, tag = "1")]
    pub name: ::prost::alloc::string::String,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct DeleteJobsByPrefixRequestAlpha1 {
...
pub struct ConversationRequestAlpha2 {
    ...
    #[prost(message, optional, tag = "11")]
    pub prompt_cache_retention: ::core::option::Option<::prost_types::Duration>,
}
...
pub struct ConversationResultAlpha2 {
    ...
    #[prost(message, optional, tag = "3")]
    pub usage: ::core::option::Option<ConversationResultAlpha2CompletionUsage>,
}
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct ConversationResultAlpha2CompletionUsage {
    ...
    #[prost(message, optional, tag = "5")]
    pub prompt_tokens_details: ::core::option::Option<
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct ConversationResultAlpha2CompletionUsageCompletionTokensDetails {
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct ConversationResultAlpha2CompletionUsagePromptTokensDetails {
...
pub mod dapr_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dapr.proto.runtime.v1.Dapr", "BulkPublishEvent"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn unregister_actor_reminders_by_type(
            &mut self,
            request: impl tonic::IntoRequest<
                super::UnregisterActorRemindersByTypeRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::UnregisterActorRemindersByTypeResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dapr.proto.runtime.v1.Dapr/UnregisterActorRemindersByType",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn list_actor_reminders(
            &mut self,
            request: impl tonic::IntoRequest<super::ListActorRemindersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListActorRemindersResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dapr.proto.runtime.v1.Dapr/ListActorReminders",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dapr.proto.runtime.v1.Dapr", "ListActorReminders"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn get_actor_reminder(
            &mut self,
            request: impl tonic::IntoRequest<super::GetActorReminderRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetActorReminderResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dapr.proto.runtime.v1.Dapr", "GetActorReminder"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        /// actor callbacks.
        pub async fn subscribe_actor_events_alpha1(
            &mut self,
            request: impl tonic::IntoStreamingRequest<
                Message = super::SubscribeActorEventsRequestAlpha1,
            >,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::SubscribeActorEventsResponseAlpha1>,
            >,
            tonic::Status,
        > {
            self.inner
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dapr.proto.runtime.v1.Dapr/SubscribeActorEventsAlpha1",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn converse_alpha2(
            ...
            tonic::Response<super::ConversationResponseAlpha2>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("dapr.proto.runtime.v1.Dapr", "ConverseAlpha2"));
            self.inner.unary(req, path, codec).await
        }
    }
}
